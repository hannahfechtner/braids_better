...
noncomputable def of_SemiThue_grid_style (h : SemiThueDerivation grid_style ab c)
  (hab : ab = a ++ b)
...
noncomputable def to_SemiThue_grid_style (h : PartialGrid a b c d e) :
  ...
  | horizontal_append_one g1 g2 g1_ih g2_ih =>
    ...
    simp only [SemiThue.grid_style.length, h4.2, h6.2]
    aesop
  | horizontal_append h g1 g2 g1_ih g2_ih =>
    ...
    use SemiThue.trans h4.1 h6.1
    simp only [SemiThue.grid_style.length, h6.2, h4.2]
    aesop
...
noncomputable def to_FrontierStyle (h : PartialGrid a b c d e) :
  ...
  have H3 := @FrontierStyle.of_SemiThue_grid_style (a ++ b) _ _ _  H2.1 rfl h.left_side_is_false
