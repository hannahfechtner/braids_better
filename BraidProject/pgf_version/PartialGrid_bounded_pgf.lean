import BraidProject.pgf_prefix_suffix
...
theorem partial_grid_rm_top_bottom_length (h : pgf a b c d e) (ha : remove_ones a = []) (hb : remove_ones b = [(i, true)]) :
    remove_ones c <+: [(i, true)] ∧ remove_ones e = [] ∧ h.length = 0 := by
  induction h with
  | single_gridt h =>
    cases h
    all_goals simp_all [pgf.length, remove_ones]
...
theorem partial_grid_rm_top_bottom_length_w (h : pgf a b c d e)
...
theorem partial_grid_rm_side_length (h : pgf a b c d e) (ha : remove_ones a = [(i, false)]) (hb : remove_ones b = []) :
...
theorem partial_grid_rm_side_length_w (h : pgf a b c d e)
...
theorem partial_grid_rm_top_left_length (h : pgf a b c d e) (ha : remove_ones a = [(i, false)]) (hb : remove_ones b = [(i, true)]) :
...
theorem partial_grid_rm_adjacent_length (h : pgf a b c d e)
...
theorem partial_grid_rm_separated_length (h : pgf a b c d e)
...
theorem pg_sm_g_eq1 (h : pgf a b c d e) (h1 : gridt a1 b1 f g)
  ...
  | vertical h1 h2 h1_ih h2_ih =>
    ...
    · rw [hl]
      ...
      have hi2 : i2.length ≤ h2.length := by
        ...
        | r1 :: r2 =>
          have i3 := pgf.extend_side_w_len i2 (List.map (fun x => (some x.1, x.2)) (r1 :: r2))
    ...
    · rw [hl, gridt.length]
      ...
      have two : i2.length ≤ h2.length := by
        ...
        | r1 :: r2 =>
          ...
          have H := pgf.extend_bottom_w_len i2
