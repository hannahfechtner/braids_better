...
theorem helper_pg_empty (h : pgf a b c d e) : remove_ones a = [] → remove_ones b =  [] →
    remove_ones c = [] ∧ remove_ones e = [] ∧ h.length = 0 := by
  induction h with
  | single_gridt h =>
    cases h with
    | empty => simp [pgf.length, remove_ones]
    | top_bottom i => simp [pgf.length, remove_ones]
    | sides i => simp [pgf.length, remove_ones]
    | top_left i =>
      intro ha
  ...
  | horizontal_append_one g1 g2 g1_ih g2_ih =>
    ...
    rw [remove_ones_append, pgf.length]
    aesop
...
theorem empty_rm_pg_len (h : pgf a b c d e) : remove_ones a = [] → remove_ones b =  [] →
    h.length = 0 := by
...
theorem frontier_options_from_vertical (h1 : pgf a b mid d2 e2)
    (i1 : pgf a2 b mid4 e5 d5) (i2 : pgf a1 mid4 mid d4 e4)
...
theorem frontier_options_from_horizontal (h1 : pgf a b mid d2 e2)
    (i1 : pgf a b1 d3 e3 mid1) (i2 : pgf mid1 b2 d4 e4 e2)
...
theorem partial_grid_rm_empty_helper (h : pgf a b c d e) : remove_ones a = [] → remove_ones b = [] →
...
theorem partial_grid_rm_top_helper (h : pgf a b c d e) : remove_ones a = [] → remove_ones b = [(i, true)] →
...
-- noncomputable def partial_grid_rm_top_helper_c (h : pgf a b c d e) : remove_ones a = [] → remove_ones b = [(i, true)] →
...
theorem partial_grid_rm_top_helper_w (h : pgf a b c d e)
...
theorem partial_grid_rm_side_helper (h : pgf a b c d e)
...
-- noncomputable def partial_grid_rm_side_helper_c (h : pgf a b c d e)
--     (h1 : remove_ones a = [(i, false)]) (h2 : remove_ones b = []) :
...
theorem partial_grid_rm_side_helper_w (h : pgf a b c d e)
...
theorem partial_grid_rm_top_left_helper (h : pgf a b c d e) (h1 : remove_ones a = [(i, false)])
...
-- noncomputable def partial_grid_rm_top_left_helper_c (h : pgf a b c d e) (h1 : remove_ones a = [(i, false)])
...
theorem partial_grid_rm_adjacent_helper (h : pgf a b c d e) (h1 : remove_ones a = [(i, false)])
...
theorem partial_grid_rm_separated_helper (h : pgf a b c d e) (h1 : remove_ones a = [(i, false)])
    (h2 : remove_ones b = [(j, true)]) (hij : i.dist j > 1): (remove_ones c = [] ∧ remove_ones d = [(i, false), (j, true)] ∧ remove_ones e = []) ∨
...
-- noncomputable def partial_grid_rm_separated_helper_c (h : pgf a b c d e) (h1 : remove_ones a = [(i, false)])
...
theorem same_time (h : gridt i j k l) (h1 : pgf a b mid d2 e2)
...
noncomputable def same_time_c (h : gridt i j k l) (h1 : pgf a b mid d2 e2)
